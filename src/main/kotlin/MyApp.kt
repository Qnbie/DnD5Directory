...
//
// val greekLetters = emptyList<APIReference>().asObservable()
//
...
// }
// }
// setup(hello, fab, greekLetters , client)
// }
// }
//
// fun setup(hello: Text, fab: Circle, greekLetters: List<APIReference>,  client: HttpClient) {
